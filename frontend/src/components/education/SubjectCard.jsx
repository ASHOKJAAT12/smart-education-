...
const SubjectCard = ({ subject, courseId }) => {
    const { _id, name, description, order, isPublished } = subject;
    return (
        <Link
            to={`/subjects/${_id}`}
        ...
        >
            <div className="flex items-center gap-3 min-w-0">
                <div className="flex-shrink-0 w-9 h-9 rounded-lg bg-violet-600/20 border border-violet-500/30 flex items-center justify-center">
